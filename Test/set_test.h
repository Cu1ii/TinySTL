#ifndef TINYSTL_SET_TEST_H_
#define TINYSTL_SET_TEST_H_
...
void set_test()
{
#define DEBUG() std::cout<<"------------1----------------"<<std::endl;
#define DEBUGROOT() std::cout <<"------root:  " << *s1.begin()<<std::endl;
  std::cout << "[===============================================================]" << std::endl;
